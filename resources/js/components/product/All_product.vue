                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr v-for="employee in filteredEmployees" :key="employee.id">
                            ...
                            <td>
                                <img :src="`/backend/images/employee/${employee.image}`" alt="Employee Image" width="55"
                                    height="55" />
                            </td>
                            <td>
                                    ...
                                    <div class="card-body">
                                        <form @submit.prevent="updateEmployee" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputJoinDate" type="date"
                                                            placeholder="Joining Date" v-model="form.join_date" />
                                                        <small class="text-danger" v-if="errors.join_date">{{
                                                            errors.join_date[0] }}</small>
